        ...
        public override void Play()
        {
            ...
            foreach (Player player in Players)
            {
                ...
                try
                {
                    ...
                    if (times <= 0)
                    {
                        Console.WriteLine("Nice try! very funny.");
                        return;
                    }
            ...
            foreach (Player player in Players)
            {
                ...
                while (!validAnswer)
                {
                    ...
                    if (!validAnswer) Console.WriteLine("Please enter a valid bet");
                }

                // Using a custom made Exception
                if (bet < 0)
                {
                    throw new FraudException("Security! Kick this player Out!!!");
                }
